...
public class UsersTransactionDatabaseHelper extends SQLiteOpenHelper {
    ...
    public UsersTransactionDatabaseHelper(@Nullable Context context) {
    ...
    public boolean insertTransferData (String sender, String receiver, int amount ) {
        ...
        contentValues.put(TABLE_NAME , sender) ;
        contentValues.put(TABLE_NAME , receiver) ;
        contentValues.put(TABLE_NAME , amount) ;
